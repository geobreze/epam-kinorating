    ...
    public Command create(String command) {
        ...
        switch (command) {
            ...
            case ShowUserListCommand.NAME: {
                UserService userService = serviceFactory.createUserService();
                PageableContentCommandHelper<User> pageableContentCommandHelper = new PageableContentCommandHelper<>(userService, paginationHelper);
                commandObject = new ShowUserListCommand(pageableContentCommandHelper);
                break;
            }
